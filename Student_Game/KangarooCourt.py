...
def intro():
    ...
    print("\n\n")
    print_slow("\033[1;32;40mJUDGE: Will the defendant please rise and state their name.")
    print("\n\n\033[0;37;40m")
    global name
    name = input()
    print("\n")
...
def closing_statement():
    def defendant_plead():
        global karma
        print_slow("\033[0;37;40mYou return to your seat. The court is silent - waiting excitedly for the JUDGE.")
        print("\n\n")
